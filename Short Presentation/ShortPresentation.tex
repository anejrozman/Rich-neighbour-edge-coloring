...
\section{Plan}
Our assingnment is to create an algorthm that 'proves' the conjecture for  regular graphs of degree 4$\geq$ 
(So it finds a rich-neighbor edge coloring for every graph, for example for all 5-regular graphs with 5 veriticies), 
and to make a random search algorythm at the point where our algorythm is too slow.
