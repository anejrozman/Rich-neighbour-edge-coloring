...
\section{Algorithms}
    ...
    \subsection{Integer Programming}
        ...
        Using SageMath we implemented an integer program that finds a rich-neighbor edge coloring for a given graph using the smallest number of colors possible. Writen matematically, our interger program looks like this:\\
        ...
        \pagebreak
        Our actual implementation of the IPL is demonstrated in the following code.
