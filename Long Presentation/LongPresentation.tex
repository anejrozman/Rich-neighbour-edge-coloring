...
\section{Complete search}
    %Since the number of k-regular graphs on n verices increases exponentially with n, we can't check all of them. We can however check all of them for footnotesize values of n.
