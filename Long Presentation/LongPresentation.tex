...
\section{Algorithms}
    ...
    \subsection{Integer Programming}
        ...
        Using SageMath we implement an integer programming model that finds a rich-neighbor edge coloring for a given graph using the smallest number of colors possible. Writen matematically, our interger program looks like this:\\
